...
void init_root_sd(u8 **sd_val, int *sd_val_len)
{
    ...
    static char sd_array[0x102c];       // 0x102c => 4140
    *sd_val_len = 0x102c;
    *sd_val = (u8*)&sd_array;
    ...
    *sub_authorities = const_cpu_to_le32(DOMAIN_ALIAS_RID_ADMINS);
    ...
    ace->type = ACCESS_ALLOWED_ACE_TYPE;
    ace->flags = OBJECT_INHERIT_ACE | CONTAINER_INHERIT_ACE | INHERIT_ONLY_ACE;
    ace->size = const_cpu_to_le16(0x18);
    ...
    *sub_authorities = const_cpu_to_le32(DOMAIN_ALIAS_RID_ADMINS);
    ...
    ace->sid.identifier_authority.value[4] = 0;
    ace->sid.identifier_authority.value[5] = 5;
    ace->sid.sub_authority[0] = const_cpu_to_le32(SECURITY_LOCAL_SYSTEM_RID);
    ...
    ace->sid.identifier_authority.value[4] = 0;
    ace->sid.identifier_authority.value[5] = 5;
    ace->sid.sub_authority[0] = const_cpu_to_le32(SECURITY_AUTHENTICATED_USER_RID);
 ...
 */
    ...
    ace->sid.identifier_authority.value[4] = 0;
    ace->sid.identifier_authority.value[5] = 5;
    ace->sid.sub_authority[0] = const_cpu_to_le32(SECURITY_BUILTIN_DOMAIN_RID);
 ...
 */
    ...
    //security descriptor relative
    sd = (SECURITY_DESCRIPTOR_RELATIVE*)((char*)sds + sizeof(SECURITY_DESCRIPTOR_HEADER));
    sd->revision = 0x01;
    sd->alignment = 0x00;
    sd->control = SE_SELF_RELATIVE | SE_DACL_PRESENT;
    sd->owner = const_cpu_to_le32(0x48);
